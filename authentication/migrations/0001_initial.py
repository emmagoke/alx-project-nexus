# Generated by Django 5.2.4 on 2025-08-10 14:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('admin', 'Administrator'), ('moderator', 'Moderator'), ('user', 'Regular User')], default='user', max_length=10)),
                ('api_calls_count', models.PositiveIntegerField(default=0)),
                ('api_calls_reset_time', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(blank=True, through='authentication.UserRole', through_fields=('user', 'role'), to='authentication.role'),
        ),
    ]
